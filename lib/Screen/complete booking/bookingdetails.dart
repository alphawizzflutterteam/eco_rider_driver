...
class BookingDetails extends StatefulWidget {
  ...
  String? driverId;
  BookingDetails({Key? key, this.compleateDeliver, this.driverId})
      : super(key: key);
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
                ...
                children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                                image: NetworkImage(
                                    '${widget.compleateDeliver?.userImage}'),
                                fit: BoxFit.fill)),
                      ),
                      const Spacer(),
                      Column(
                        children: [
                          ...
                          InkWell(
                            onTap: () {
                              _launchEmailApp(
                                  "${widget.compleateDeliver?.userEmail}");
                            },
                            child: Container(
                              height: 30,
                              width: 30,
                  ...
                  //   onTap: () {
                  //     print(
                  //         "===my technic=======${widget.compleateDeliver?.userLat}===============");
                  //     print(
                  //         "===my technic=======${widget.compleateDeliver?.userLang}===============");
                  //     Navigator.push(
                  //       context,
                  //       MaterialPageRoute(
                  //           builder: (context) => UserMapScreen(
                  //                 DriverId: widget.driverId,
                  //                 userlat: widget.compleateDeliver?.userLat,
                  //                 userlang: widget.compleateDeliver?.userLang,
                  //               )),
                  //     );
                  //   },
                  //   child: Column(
                          ...
                          child: Column(
                            children: [
                              ...
                              Container(
                                ...
                                child: const Center(
                                  child: Text(
                                    'Press For Complete This Order',
                                    style:
                                        TextStyle(color: AppColors.whiteTemp),
                                  ),
                                ),
                              ),
                            ],
