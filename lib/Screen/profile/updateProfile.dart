  ...
  getuserdata() async {
    ...
    apiBaseHelper.postAPICall(getprofileurl, param).then(
      (getDta) {
        ...
        if (error == true) {
          print(
              "===my technic==== api===${getDta['data']['gender']}===============");
  ...
  Future<void> updateProfile() async {
    ...
    if (userImg != null) {
      List<Map<String, dynamic>> imagefile = [
        {"key": "user_image", "filePath": "${userImg!.path}"},
      ];
      ...
      List<Map<String, dynamic>> imagefile = [
        {"key": "aadhar_card_f", "filePath": "${adharfronImg!.path}"},
      ];
      ...
      List<Map<String, dynamic>> imagefile = [
        {"key": "aadhar_card_b", "filePath": "${adharbackImg!.path}"},
      ];
      ...
      List<Map<String, dynamic>> imagefile = [
        {"key": "driving_licence_photo", "filePath": "${licenceImg!.path}"},
      ];
    ...
    apiBaseHelper
        .postMultipartAPICall(userUpdateurl, param, checKImageFile)
        .then((getData) {
